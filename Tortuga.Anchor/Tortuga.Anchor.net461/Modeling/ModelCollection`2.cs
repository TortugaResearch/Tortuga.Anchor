...
namespace Tortuga.Anchor.Modeling
{
    ...
    public abstract partial class ModelCollection<T, TPropertyTracking> : ObservableCollectionExtended<T>, INotifyDataErrorInfo
        where TPropertyTracking : PropertyBagBase
    {
        ...
        internal void OnErrorsChanged(string propertyName, ErrorsDictionaryUpdateType updateType)
        {
            ...
            if (updateType == ErrorsDictionaryUpdateType.HasErrorsIsFalse || updateType == ErrorsDictionaryUpdateType.HasErrorsIsTrue)
                OnPropertyChanged(Internals.CommonProperties.HasErrorsProperty);
        }
...
#if DataErrorInfo
    partial class ModelCollection<T, TPropertyTracking> : IDataErrorInfo
    {
        /// <summary>
