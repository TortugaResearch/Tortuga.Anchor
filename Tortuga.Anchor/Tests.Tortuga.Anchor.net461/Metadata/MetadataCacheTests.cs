    ...
    public class MetadataCacheTests
    {
        ...
        public void MetadataCache_PublicProperty_Test()
        {
            using (var verify = new Verify())
            {
                ...
                verify.AreEqual(0, publicProperty.CalculatedFields.Count, "not used in calculated fields");
                ...
                verify.AreEqual(0, publicProperty.Validators.Count, "not used in validation");
            }
        }
        ...
        public void MetadataCache_PublicPrivateProperty_Test()
        {
            using (var verify = new Verify())
            {
                ...
                verify.AreEqual(0, publicPrivateProperty.CalculatedFields.Count, "not used in calculated fields");
                ...
                verify.AreEqual(0, publicPrivateProperty.Validators.Count, "not used in validation");
            }
        }
        ...
        public void MetadataCache_PublicProtectedProperty_Test()
        {
            using (var verify = new Verify())
            {
                ...
                verify.AreEqual(0, publicProtectedProperty.CalculatedFields.Count, "not used in calculated fields");
                ...
                verify.AreEqual(0, publicProtectedProperty.Validators.Count, "not used in validation");
            }
        }
        ...
        public void MetadataCache_ProtectedProperty_Test()
        {
            using (var verify = new Verify())
            {
                ...
                verify.AreEqual(0, protectedProperty.CalculatedFields.Count, "not used in calculated fields");
                ...
                verify.AreEqual(0, protectedProperty.Validators.Count, "not used in validation");
            }
        }
        ...
        public void MetadataCache_PrivateProperty_Test()
        {
            using (var verify = new Verify())
            {
                ...
                verify.AreEqual(0, privateProperty.CalculatedFields.Count, "not used in calculated fields");
                ...
                verify.AreEqual(0, privateProperty.Validators.Count, "not used in validation");
            }
        }
        ...
        public void MetadataCache_SetOnlyProperty_Test()
        {
            using (var verify = new Verify())
            {
                ...
                verify.AreEqual(0, setOnlyProperty.CalculatedFields.Count, "not used in calculated fields");
                ...
                verify.AreEqual(0, setOnlyProperty.Validators.Count, "not used in validation");
            }
        }
